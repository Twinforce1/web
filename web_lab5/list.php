...
<ul id="myUL">
    ...
    <?php
    $i = 1;
    $sql="SELECT * FROM BLOG WHERE id = '$i'" ;
    ...
    while ($i <= $MAX_NUMBER_TASKS) {
        ...
        <li>
            ...
            <a href=<?php echo $update_link;?>> <?php echo $data["title"];?></a>
            <a href=<?php echo $update_link;?>> <?php echo $data["description"];?></a>
            <a href=<?php echo $update_link;?>> <?php echo $data["time"];?></a>
